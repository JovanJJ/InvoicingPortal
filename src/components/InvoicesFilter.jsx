    ...
    return (
        <div className="max-w-4xl mx-auto pt-10  pb-10">
            <div className="flex flex-col md:flex-row justify-between gap-4 ">
                ...
                <div>
                    <div className="border border-gray-300 rounded p-1">Project -
                        <select
                ...
                <div className="border border-gray-300 rounded p-1">Client -
                    <select
                        value={currentClient}
                ...
                <div>
                    <div className="border border-gray-300 rounded p-1">Status -
                        <select
                            value={currentStatus}
