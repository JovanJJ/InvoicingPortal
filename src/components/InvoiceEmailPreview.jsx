      ...
      <div style={{ width: '100%', maxWidth: 640, maxHeight: '90vh', overflow: 'auto' }}>
        <div onClick={(e) => e.stopPropagation()} style={{
          ...
          <div style={{ padding: 40, borderBottom: '1px solid #f3f4f6' }}>
            ...
            <img src={user?.avatar || user?.logo} alt="logo" style={{ width: 20, height: 20 }} />
          </div>
            ...
            <table width="100%" border="0" cellPadding="0" cellSpacing="0" style={{ borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ backgroundColor: '#4f46e5' }}>
                  ...
                  <th style={{ padding: '12px 20px', textAlign: 'left', fontSize: 11, fontWeight: 700, color: '#ffffff', textTransform: 'uppercase' }}>Qty</th>
                  <th style={{ padding: '12px 20px', textAlign: 'right', fontSize: 11, fontWeight: 700, color: '#ffffff', textTransform: 'uppercase' }}>Total</th>
                </tr>
              </thead>
              <tbody>
